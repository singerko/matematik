...
Aplikácia beží ako webová služba aj ako mobilná aplikácia pre Android. Webová verzia je dostupná na adrese [https://matematik.premna.sk/](https://matematik.premna.sk/). Android verzia má aj hlasový výstup a vie žiaka naviesť na správne riešenie, keď sa pomýli alebo potrebuje vysvetlenie postupu.
